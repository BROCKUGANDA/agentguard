  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        xl: '0 20px 25px -5px rgb(0 0 0 / 0.12), 0 8px 10px -6px rgb(0 0 0 / 0.05)',
      },
      keyframes: {
        'volcano-pulse': {
      ...
      animation: {
        'volcano-pulse': 'volcano-pulse 1.5s ease-in-out infinite',
        shimmer: 'shimmer 1.2s linear infinite',
        'agent-think': 'agent-think 1.5s ease-in-out infinite',
        'agent-shake': 'agent-shake 0.3s ease-in-out',
